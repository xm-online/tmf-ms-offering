[![Build Status](https://travis-ci.org/xm-online/tmf-ms-offering.svg?branch=master)](https://travis-ci.org/xm-online/tmf-ms-offering) [![Quality Gate](https://sonarcloud.io/api/project_badges/measure?&metric=sqale_index&branch=master&project=xm-online:tmf-ms-offering)](https://sonarcloud.io/dashboard/index/xm-online:tmf-ms-offering) [![Quality Gate](https://sonarcloud.io/api/project_badges/measure?&metric=ncloc&branch=master&project=xm-online:tmf-ms-offering)](https://sonarcloud.io/dashboard/index/xm-online:tmf-ms-offering) [![Quality Gate](https://sonarcloud.io/api/project_badges/measure?&metric=coverage&branch=master&project=xm-online:tmf-ms-offering)](https://sonarcloud.io/dashboard/index/xm-online:tmf-ms-offering)
...
To build the final jar and optimize the offering application for production, run:
